...
public class HttpTest {  
    ...
    public HttpTest(String host,int port) throws Exception{  
        this.host = host;  
        this.port = port;  
        /**  
         * http协议  
    ...
    public static void main(String[] args) throws Exception {  
         ...
         * http协议测试  
         */  
    	//HttpTest forHttpTest = new HttpTest("www.so.com", 80);  
        /**  
         * https协议测试  
         */  
    	HttpTest forHttpTest = new HttpTest("www.baidu.com", 443);  
        try {  
            //forHttpTest.sendGet();  
