...
public class jdGui {
	...
	public static void main(String[] args) throws Exception{
		...
		String folder = "D:/workspace/qcsoft/src/main/java/org/apache/ibatis/abator/internal/sqlmap/";
	...
	public static boolean replaceFile(String filePath)
		...
		try{
			...
			while((line=br.readLine())!=null){
				...
				if(text.indexOf("Location:")>=0 && text.indexOf("/*")>=0) {
					x = 1;
					continue;
				}
				if(text.indexOf("* Qualified Name:")>=0) {
					y = 1;
					continue;
				}
				if(text.indexOf("* JD-Core Version:")>=0) {
					z = 1;
					continue;
				}
